!function($) {
    ...
    lm.utils.createObject = function(t) {
        return "function" == typeof Object.create ? Object.create(t) : (lm.utils.F.prototype = t,
        new lm.utils.F)
    }
    ,
    ...
    lm.utils.getQueryStringParam = function(t) {
        if (window.location.hash)
            return lm.utils.getHashValue(t);
        if (!window.location.search)
            return null;
        var e, i, n = window.location.search.substr(1).split("&"), s = {};
    ...
    ,
    "function" != typeof /./ && "object" != typeof Int8Array ? lm.utils.isFunction = function(t) {
    ...
    lm.utils.EventEmitter = function() {
        ...
        this.on = function(t, e, i) {
            if (!lm.utils.isFunction(e))
                throw new Error("Tried to listen to event " + t + " with non-function callback " + e);
            this._mSubscriptions[t] || (this._mSubscriptions[t] = []),
            this._mSubscriptions[t].push({
                fn: e,
                ctx: i
            })
        }
        ...
        this.emit = function(t) {
            var e, i, n;
            if (n = Array.prototype.slice.call(arguments, 1),
            ...
            for (n.unshift(t),
            e = 0; e < this._mSubscriptions[lm.utils.EventEmitter.ALL_EVENT].length; e++)
        ...
        this.unbind = function(t, e, i) {
            ...
            for (n = 0; n < this._mSubscriptions[t].length; n++)
                e && this._mSubscriptions[t][n].fn !== e || i && i !== this._mSubscriptions[t][n].ctx || (this._mSubscriptions[t].splice(n, 1),
                s = !0);
            if (s === !1)
                throw new Error("Nothing to unbind for " + t)
        }
        ,
    ...
    lm.utils.copy(lm.utils.DragListener.prototype, {
        ...
        onMouseMove: function(t) {
            if (null != this._timeout) {
                ...
                this._bDragging === !1 && (Math.abs(this._nX) > this._nDistance || Math.abs(this._nY) > this._nDistance) && (clearTimeout(this._timeout),
                this._startDrag()),
        ...
        onMouseUp: function(t) {
            ...
            this._bDragging === !0 && (this._bDragging = !1,
        ...
        _getCoordinates: function(t) {
            return t = t.originalEvent && t.originalEvent.touches ? t.originalEvent.touches[0] : t,
            {
                x: t.pageX,
                y: t.pageY
            }
    ...
    lm.utils.copy(lm.LayoutManager.prototype, {
        ...
        toConfig: function(t) {
            ...
            i = function(t, e) {
                ...
                if (e.contentItems.length)
                    for (t.content = [],
                    s = 0; s < e.contentItems.length; s++)
                        t.content[s] = {},
                        i(t.content[s], e.contentItems[s])
            }
            ,
            t ? i(e, {
                contentItems: [t]
            ...
            e.openPopouts = [],
            n = 0; n < this.openPopouts.length; n++)
        ...
        init: function() {
            return this._subWindowsCreated === !1 && (this._createSubWindows(),
            this._subWindowsCreated = !0),
            "loading" === document.readyState || null === document.body ? void $(document).ready(lm.utils.fnBind(this.init, this)) : this.isSubWindow === !0 && this._creationTimeoutPassed === !1 ? (setTimeout(lm.utils.fnBind(this.init, this), 7),
            void (this._creationTimeoutPassed = !0)) : (this.isSubWindow === !0 && this._adjustToWindowMode(),
            this._setContainer(),
        ...
        updateSize: function(t, e) {
            2 === arguments.length ? (this.width = t,
            this.height = e) : (this.width = this.container.width(),
            this.height = this.container.height()),
            this.isInitialised === !0 && (this.root.callDownwards("setSize", [this.width, this.height]),
            this._maximisedItem && (this._maximisedItem.element.width(this.container.width()),
            this._maximisedItem.element.height(this.container.height()),
            this._maximisedItem.callDownwards("setSize")),
            this._adjustColumnsResponsive())
        },
        destroy: function() {
            this.isInitialised !== !1 && (this._onUnload(),
        ...
        createContentItem: function(t, e) {
            ...
            if ("react-component" === t.type && (t.type = "component",
            t.componentName = "lm-react-component"),
            !this._typeToItem[t.type])
                throw i = "Unknown type '" + t.type + "'. Valid types are " + lm.utils.objectKeys(this._typeToItem).join(","),
        ...
        createPopout: function(t, e, i, n) {
            var s, o, r, a, h, l, m = t, c = t instanceof lm.items.AbstractContentItem, d = this;
            if (i = i || null,
            c) {
                for (m = this.toConfig(t).content,
                i = lm.utils.getUniqueId(),
                a = t.parent,
                h = t; 1 === a.contentItems.length && !a.isRoot; )
                    a = a.parent,
                    h = h.parent;
                a.addId(i),
                isNaN(n) && (n = lm.utils.indexOf(h, a.contentItems))
            } else
                m instanceof Array || (m = [m]);
            return !e && c && (s = window.screenX || window.screenLeft,
        ...
        createDragSource: function(t, e) {
            ...
            return this._dragSources.push(i),
            i
        },
        selectItem: function(t, e) {
            if (this.config.settings.selectionEnabled !== !0)
                throw new Error("Please set selectionEnabled to true to use this feature");
            t !== this.selectedItem && (null !== this.selectedItem && this.selectedItem.deselect(),
            t && e !== !0 && t.select(),
            this.selectedItem = t,
        ...
        _$getArea: function(t, e) {
            var i, n, s = 1 / 0, o = null;
            for (i = 0; i < this._itemAreas.length; i++)
                n = this._itemAreas[i],
                t > n.x1 && t < n.x2 && e > n.y1 && e < n.y2 && s > n.surface && (s = n.surface,
                o = n);
            return o
        },
        _$createRootItemAreas: function() {
            ...
            for (side in sides) {
                ...
                with (area.side = side,
                sides[side] ? area[side] = area[sides[side]] - areaSize : area[side] = areaSize,
                area)
                    surface = (x2 - x1) * (y2 - y1);
        ...
        _$calculateItemAreas: function() {
            ...
            if (this._itemAreas = [],
            1 === allContentItems.length)
                return void this._itemAreas.push(this.root._$getArea());
            for (this._$createRootItemAreas(),
            i = 0; i < allContentItems.length; i++)
                if (allContentItems[i].isStack && (area = allContentItems[i]._$getArea(),
                null !== area))
        ...
        _$reconcilePopoutWindows: function() {
            ...
            this.openPopouts.length !== e.length && (this.emit("stateChanged"),
            this.openPopouts = e)
        },
        _getAllContentItems: function() {
            var t = []
              , e = function(i) {
                if (t.push(i),
                i.contentItems instanceof Array)
        ...
        _createConfig: function(t) {
            ...
            var i = function(t) {
                for (var e in t)
                    "props" !== e && "object" == typeof t[e] ? i(t[e]) : "type" === e && "react-component" === t[e] && (t.type = "component",
                    t.componentName = "lm-react-component")
            };
            return i(t),
        ...
        _createSubWindows: function() {
            ...
            for (t = 0; t < this.config.openPopouts.length; t++)
                ...
                this.createPopout(e.content, e.dimensions, e.parentId, e.indexInParent)
        },
        _setContainer: function() {
            ...
            t[0] === document.body && (this._isFullPage = !0,
            $("html, body").css({
                height: "100%",
                margin: 0,
                padding: 0,
        ...
        _create: function(t) {
            ...
            if (!(t.content instanceof Array))
                throw e = void 0 === t.content ? "Missing setting 'content' on top level of configuration" : "Configuration parameter 'content' must be an array",
            ...
            if (!(t <= 1)) {
                ...
                if (!(i <= this.width)) {
                    ...
                    for (var n = Math.max(Math.floor(this.width / e), 1), s = t - n, o = this.root.contentItems[0], r = this._findAllStackContainers()[0], a = 0; a < s; a++) {
                        ...
                        o.removeChild(h),
                        this._addChildContentItemsToContainer(r, h)
                    }
                    this._updatingColumnsResponsive = !1
                }
            }
        ...
        _addChildContentItemsToContainer: function(t, e) {
            "stack" === e.type ? e.contentItems.forEach(function(e) {
                t.addChild(e)
            }) : e.contentItems.forEach(lm.utils.fnBind(function(e) {
                this._addChildContentItemsToContainer(t, e)
            }, this))
        },
        _findAllStackContainers: function() {
            var t = [];
            return this._findAllStackContainersRecursive(t, this.root),
            t
        },
    ...
    lm.utils.copy(lm.container.ItemContainer.prototype, {
        ...
        _$setSize: function(t, e) {
            t === this.width && e === this.height || (this.width = t,
            this.height = e,
    ...
    lm.utils.copy(lm.controls.BrowserPopout.prototype, {
        ...
        popIn: function() {
            var t, e, i = this._indexInParent;
            this._parentId && (t = $.extend(!0, {}, this.getGlInstance().toConfig()).content[0],
            e = this._layoutManager.root.getItemsById(this._parentId)[0],
            e || (e = this._layoutManager.root.contentItems.length > 0 ? this._layoutManager.root.contentItems[0] : this._layoutManager.root,
            i = 0)),
            e.addChild(t, this._indexInParent),
            this.close()
        },
        _createWindow: function() {
            var t, e = this._createUrl(), i = Math.floor(1e6 * Math.random()).toString(36), n = this._serializeWindowOptions({
            ...
            if (this._popoutWindow = window.open(e, i, n),
            this._popoutWindow)
                ...
                t = setInterval(lm.utils.fnBind(function() {
                    this._popoutWindow.__glInstance && this._popoutWindow.__glInstance.isInitialised && (this._onInitialised(),
                    clearInterval(t))
                }, this), 10);
            else if (this._layoutManager.config.settings.blockedPopoutsThrowError === !0) {
                var s = new Error("Popout blocked");
                throw s.type = "popoutBlocked",
                s
            }
        },
        ...
        _createUrl: function() {
            ...
            return t = document.location.href.split("?"),
    ...
    lm.controls.DragProxy = function(t, e, i, n, s, o) {
        ...
        o && o._side && (this._sided = o._sided,
    ...
    lm.utils.copy(lm.controls.DragProxy.prototype, {
        ...
        _setDropPosition: function(t, e) {
            ...
            null !== this._area && (this._lastValidArea = this._area,
            this._area.contentItem._$highlightDropZone(t, e, this._area))
        },
        _onDrop: function() {
            this._layoutManager.dropTargetIndicator.hide(),
            null !== this._area ? this._area.contentItem._$onDrop(this._contentItem, this._area) : null !== this._lastValidArea ? this._lastValidArea.contentItem._$onDrop(this._contentItem, this._lastValidArea) : this._originalParent ? this._originalParent.addChild(this._contentItem) : this._contentItem._$destroy(),
            this.element.remove(),
            this._layoutManager.emit("itemDropped", this._contentItem)
        },
        _updateTree: function() {
            this._contentItem.parent && this._contentItem.parent.removeChild(this._contentItem, !0),
    ...
    lm.controls.Header = function(t, e) {
        ...
        this.layoutManager.config.settings.selectionEnabled === !0 && (this.element.addClass("lm_selectable"),
    ...
    lm.utils.copy(lm.controls.Header.prototype, {
        createTab: function(t, e) {
            ...
            for (n = 0; n < this.tabs.length; n++)
                if (this.tabs[n].contentItem === t)
                    return;
            return i = new lm.controls.Tab(this,t),
            0 === this.tabs.length ? (this.tabs.push(i),
            void this.tabsContainer.append(i.element)) : (void 0 === e && (e = this.tabs.length),
        ...
        removeTab: function(t) {
            for (var e = 0; e < this.tabs.length; e++)
                if (this.tabs[e].contentItem === t)
                    return this.tabs[e]._$destroy(),
                    void this.tabs.splice(e, 1);
        ...
        setActiveContentItem: function(t) {
            ...
            for (e = 0; e < this.tabs.length; e++)
                ...
                n === !0 && (this.activeContentItem = t,
                this.parent.config.activeItemIndex = e);
            if (this._lastVisibleTabIndex !== -1 && this.parent.config.activeItemIndex > this._lastVisibleTabIndex) {
                for (s = this.tabs[this.parent.config.activeItemIndex],
                i = this.parent.config.activeItemIndex; i > 0; i--)
        ...
        position: function(t) {
            ...
            return e && !this.parent._side && (e = "top"),
            void 0 !== t && this.parent._header.show != t && (this.parent._header.show = t,
            this.parent._setupHeaderPosition()),
            e
        },
        _$setClosable: function(t) {
            return !(!this.closeButton || !this._isClosable()) && (this.closeButton.element[t ? "show" : "hide"](),
            !0)
        },
        _$destroy: function() {
            this.emit("destroy", this);
            for (var t = 0; t < this.tabs.length; t++)
                this.tabs[t]._$destroy();
            this.element.remove()
        },
        _getHeaderSetting: function(t) {
            if (t in this.parent._header)
                return this.parent._header[t]
        },
        _createControls: function() {
            ...
            this._getHeaderSetting("popout") && (e = lm.utils.fnBind(this._onPopoutClick, this),
            i = this._getHeaderSetting("popout"),
            new lm.controls.HeaderButton(this,i,"lm_popout",e)),
            this._getHeaderSetting("maximise") && (o = lm.utils.fnBind(this.parent.toggleMaximise, this.parent),
            ...
            this._isClosable() && (t = lm.utils.fnBind(this.parent.remove, this.parent),
        ...
        _updateTabSizes: function() {
            if (0 !== this.tabs.length) {
                ...
                var e, i, n, s, o = this.element.outerWidth() - this.controlsContainer.outerWidth() - this._tabControlOffset, r = 0, a = !1;
                for (this.parent._sided && (o = this.element.outerHeight() - this.controlsContainer.outerHeight() - this._tabControlOffset),
                this._lastVisibleTabIndex = -1,
                i = 0; i < this.tabs.length; i++)
                    ...
                    r += s,
                    r > o && a ? (e.data("lastTabWidth", s),
                    this.tabDropdownContainer.append(e)) : (a = !0,
                    this._lastVisibleTabIndex = i,
                    e.removeData("lastTabWidth"),
                    this.tabsContainer.append(e));
                n = r > o,
                this.tabDropdownButton.element[n ? "show" : "hide"]()
            }
        }
    }),
    ...
    lm.utils.copy(lm.controls.Splitter.prototype, {
        ...
        _createElement: function() {
            ...
            return t.addClass("lm_" + (this._isVertical ? "vertical" : "horizontal")),
    ...
    lm.controls.Tab = function(t, e) {
        ...
        this._layoutManager.config.settings.reorderEnabled === !0 && e.config.reorderEnabled === !0 && (this._dragListener = new lm.utils.DragListener(this.element),
        this._dragListener.on("dragStart", this._onDragStart, this)),
        ...
        this.contentItem.isComponent && (this.contentItem.container.tab = this,
    ...
    lm.utils.copy(lm.controls.Tab.prototype, {
        ...
        setActive: function(t) {
            ...
            t ? this.element.addClass("lm_active") : this.element.removeClass("lm_active"))
        },
        _$destroy: function() {
            this.element.off("mousedown touchstart", this._onTabClickFn),
            this.closeElement.off("click touchstart", this._onCloseClickFn),
            this._dragListener && (this._dragListener.off("dragStart", this._onDragStart),
            this._dragListener = null),
            this.element.remove()
        },
        _onDragStart: function(t, e) {
        ...
        _onTabClick: function(t) {
            if (0 === t.button || "touchstart" === t.type) {
                ...
                1 === t.button && this.contentItem.config.isClosable && this._onCloseClick(t)
        },
    ...
    lm.utils.copy(lm.controls.TransitionIndicator.prototype, {
        ...
        _nextAnimationFrame: function() {
            var t, e = this._measure(this._toElement), i = (lm.utils.now() - this._animationStartTime) / this._totalAnimationDuration, n = {};
            if (i >= 1)
                return void this._element.hide();
            e.opacity = 0;
    ...
    lm.utils.copy(lm.items.AbstractContentItem.prototype, {
        ...
        callDownwards: function(t, e, i, n) {
            var s;
            for (i !== !0 && n !== !0 && this[t].apply(this, e || []),
            s = 0; s < this.contentItems.length; s++)
        ...
        popout: function() {
            ...
            return this.emitBubblingEvent("stateChanged"),
            t
        },
        ...
        select: function() {
            this.layoutManager.selectedItem !== this && (this.layoutManager.selectItem(this, !0),
            this.element.addClass("lm_selected"))
        },
        deselect: function() {
            this.layoutManager.selectedItem === this && (this.layoutManager.selectedItem = null,
        ...
        removeId: function(t) {
            ...
            if ("string" == typeof this.config.id)
        ...
        getComponentsByName: function(t) {
            var e, i = this._$getItemsByProperty("componentName", t), n = [];
        ...
        _$init: function() {
            var t;
            for (this.setSize(),
            t = 0; t < this.contentItems.length; t++)
        ...
        _propagateEvent: function(t, e) {
            e instanceof lm.utils.BubblingEvent && e.isPropagationStopped === !1 && this.isInitialised === !0 && (this.isRoot === !1 && this.parent ? this.parent.emit.apply(this.parent, Array.prototype.slice.call(arguments, 0)) : this._scheduleEventPropagationToLayoutManager(t, e))
        },
        _scheduleEventPropagationToLayoutManager: function(t, e) {
            lm.utils.indexOf(t, this._throttledEvents) === -1 ? this.layoutManager.emit(t, e.origin) : this._pendingEventPropagations[t] !== !0 && (this._pendingEventPropagations[t] = !0,
        ...
        _propagateEventToLayoutManager: function(t, e) {
            this._pendingEventPropagations[t] = !1,
            this.layoutManager.emit(t, e)
        }
    }),
    ...
    lm.utils.copy(lm.items.Root.prototype, {
        ...
        setSize: function(t, e) {
            ...
            this.contentItems[0] && (this.contentItems[0].element.width(t),
        ...
        _$onDrop: function(t, e) {
            var i;
            if (t.isComponent && (i = this.layoutManager.createContentItem({
                type: "stack",
            ...
            this.contentItems.length) {
                ...
                if (!r instanceof lm.items.RowOrColumn || r.type != n) {
                    var a = this.layoutManager.createContentItem({
                        type: n
                    }, this);
    ...
    lm.utils.copy(lm.items.RowOrColumn.prototype, {
        addChild: function(t, e, i) {
            var n, s, o, r;
            if (t = this.layoutManager._$normalizeContentItem(t, this),
            void 0 === e && (e = this.contentItems.length),
            this.contentItems.length > 0 ? (r = this._createSplitter(Math.max(0, e - 1)).element,
            e > 0 ? (this.contentItems[e - 1].element.after(r),
            r.after(t.element)) : (this.contentItems[0].element.before(r),
            r.before(t.element))) : this.childElementContainer.append(t.element),
            ...
            for (o = 0; o < this.contentItems.length; o++)
                this.contentItems[o] === t ? t.config[this._dimension] = n : (s = this.contentItems[o].config[this._dimension] *= (100 - n) / 100,
                this.contentItems[o].config[this._dimension] = s);
            this.callDownwards("setSize"),
            this.emitBubblingEvent("stateChanged")
        },
        removeChild: function(t, e) {
            var i, n, s = t.config[this._dimension], o = lm.utils.indexOf(t, this.contentItems), r = Math.max(o - 1, 0);
            if (o === -1)
                throw new Error("Can't remove child. ContentItem is not child of this Row or Column");
            for (this._splitter[r] && (this._splitter[r]._$destroy(),
            this._splitter.splice(r, 1)),
            i = 0; i < this.contentItems.length; i++)
            ...
            1 === this.contentItems.length && this.config.isClosable === !0 ? (n = this.contentItems[0],
            this.contentItems = [],
            this.parent.replaceChild(this, n, !0)) : (this.callDownwards("setSize"),
            this.emitBubblingEvent("stateChanged"))
        },
        ...
        setSize: function() {
            this.contentItems.length > 0 && (this._calculateRelativeSizes(),
        ...
        _$init: function() {
            if (this.isInitialised !== !0) {
                var t;
                for (lm.items.AbstractContentItem.prototype._$init.call(this),
                t = 0; t < this.contentItems.length - 1; t++)
                    this.contentItems[t].element.after(this._createSplitter(t).element)
            }
        },
        _setAbsoluteSizes: function() {
            var t, e = this._calculateAbsoluteSizes();
            for (t = 0; t < this.contentItems.length; t++)
                e.additionalPixel - t > 0 && e.itemSizes[t]++,
                this._isColumn ? (this.contentItems[t].element.width(e.totalWidth),
                this.contentItems[t].element.height(e.itemSizes[t])) : (this.contentItems[t].element.width(e.itemSizes[t]),
                this.contentItems[t].element.height(e.totalHeight))
        },
        _calculateAbsoluteSizes: function() {
            var t, e, i, n = (this.contentItems.length - 1) * this._splitterSize, s = this.element.width(), o = this.element.height(), r = 0, a = [];
            for (this._isColumn ? o -= n : s -= n,
            t = 0; t < this.contentItems.length; t++)
                i = this._isColumn ? Math.floor(o * (this.contentItems[t].config.height / 100)) : Math.floor(s * (this.contentItems[t].config.width / 100)),
                r += i,
                a.push(i);
            return e = Math.floor((this._isColumn ? o : s) - r),
            {
                itemSizes: a,
                additionalPixel: e,
                totalWidth: s,
        ...
        _calculateRelativeSizes: function() {
            var t, e = 0, i = [], n = this._isColumn ? "height" : "width";
            for (t = 0; t < this.contentItems.length; t++)
            ...
            if (Math.round(e) > 100)
                for (t = 0; t < i.length; t++)
                    ...
                    e += 50;
            for (t = 0; t < this.contentItems.length; t++)
                this.contentItems[t].config[n] = this.contentItems[t].config[n] / e * 100;
            this._respectMinItemWidth()
        },
        _respectMinItemWidth: function() {
            var t, e, n, s = this.layoutManager.config.dimensions ? this.layoutManager.config.dimensions.minItemWidth || 0 : 0, o = null, r = [], a = 0, h = 0, l = 0, m = 0, c = null, d = [];
            if (!(this._isColumn || !s || this.contentItems.length <= 1)) {
                for (o = this._calculateAbsoluteSizes(),
                i = 0; i < this.contentItems.length; i++)
        ...
        _createSplitter: function(t) {
            var e;
            return e = new lm.controls.Splitter(this._isColumn,this._splitterSize),
        ...
        _onSplitterDrag: function(t, e, i) {
            ...
            n > this._splitterMinPosition && n < this._splitterMaxPosition && (this._splitterPosition = n,
    ...
    lm.utils.copy(lm.items.Stack.prototype, {
        setSize: function() {
            var t, e = this._header.show ? this.layoutManager.config.dimensions.headerHeight : 0, i = this.element.width() - (this._sided ? e : 0), n = this.element.height() - (this._sided ? 0 : e);
            for (this.childElementContainer.width(i),
        ...
        _$init: function() {
            ...
            if (this.isInitialised !== !0) {
                ...
                if (this.contentItems.length > 0) {
                    if (e = this.contentItems[this.config.activeItemIndex || 0],
                    !e)
        ...
        _$validateClosability: function() {
            var t, e, i;
            for (t = this.header._isClosable(),
            i = 0,
            e = this.contentItems.length; i < e && t; i++)
        ...
        _$onDrop: function(t) {
            if ("header" === this._dropSegment)
                return this._resetHeaderDropZone(),
                void this.addChild(t, this._dropIndex);
            if ("body" === this._dropSegment)
                return void this.addChild(t);
            var e, i, n, s = "top" === this._dropSegment || "bottom" === this._dropSegment, o = "left" === this._dropSegment || "right" === this._dropSegment, r = "top" === this._dropSegment || "left" === this._dropSegment, a = s && this.parent.isColumn || o && this.parent.isRow, h = s ? "column" : "row", l = s ? "height" : "width";
            ...
            i.addChild(t),
            t = i),
            a ? (e = lm.utils.indexOf(this, this.parent.contentItems),
            this.parent.addChild(t, r ? e : e + 1, !0),
            this.config[l] *= .5,
            t.config[l] = this.config[l],
            this.parent.callDownwards("setSize")) : (h = s ? "column" : "row",
            n = this.layoutManager.createContentItem({
                type: h
            }, this),
        ...
        _$highlightDropZone: function(t, e) {
            ...
            for (i in this._contentAreaDimensions)
                if (n = this._contentAreaDimensions[i].hoverArea,
                n.x1 < t && n.x2 > t && n.y1 < e && n.y2 > e)
                    return void ("header" === i ? (this._dropSegment = "header",
                    this._highlightHeaderDropZone(this._sided ? e : t)) : (this._resetHeaderDropZone(),
                    this._highlightBodyDropZone(i)))
        },
        _$getArea: function() {
        ...
        _highlightHeaderDropZone: function(t) {
            var e, i, n, s, o, r, a, h, l, m = this.header.tabs.length, c = !1;
            if (0 === m)
                return a = this.header.element.offset(),
            ...
            for (e = 0; e < m; e++)
                if (i = this.header.tabs[e].element,
                o = i.offset(),
                this._sided ? (s = o.top,
                n = o.left,
                h = i.height()) : (s = o.left,
            ...
            if (!(c === !1 && t < s)) {
                ...
                i.before(this.layoutManager.tabDropPlaceholder)) : (this._dropIndex = Math.min(e + 1, m),
                i.after(this.layoutManager.tabDropPlaceholder)),
                this._sided)
                    return placeHolderTop = this.layoutManager.tabDropPlaceholder.offset().top,
                    void this.layoutManager.dropTargetIndicator.highlightArea({
                        x1: n,
                        x2: n + i.innerHeight(),
                        y1: placeHolderTop,
        ...
        _setupHeaderPosition: function() {
            ...
            if (this.header.element.toggle(!!this._header.show),
            this._side = t,
    ...
    lm.utils.ConfigMinifier = function() {
        this._keys = ["settings", "hasHeaders", "constrainDragToContainer", "selectionEnabled", "dimensions", "borderWidth", "minItemHeight", "minItemWidth", "headerHeight", "dragProxyWidth", "dragProxyHeight", "labels", "close", "maximise", "minimise", "popout", "content", "componentName", "componentState", "id", "width", "type", "height", "isClosable", "title", "popoutWholeStack", "openPopouts", "parentId", "activeItemIndex", "reorderEnabled"],
    ...
    lm.utils.copy(lm.utils.ConfigMinifier.prototype, {
        minifyConfig: function(t) {
            var e = {};
            return this._nextLevel(t, e, "_min"),
            e
        },
        unminifyConfig: function(t) {
            var e = {};
            return this._nextLevel(t, e, "_max"),
            e
        },
        _nextLevel: function(t, e, i) {
            ...
            for (n in t)
                ...
                t.hasOwnProperty(n) && (s = this[i](n, this._keys),
                "object" == typeof t[n] ? (e[s] = t[n]instanceof Array ? [] : {},
                this._nextLevel(t[n], e[s], i)) : e[s] = this[i](t[n], this._values))
        },
        _min: function(t, e) {
    ...
    lm.utils.EventHub.prototype._$onEventFromParent = function(t) {
        this._dontPropagateToParent = t[0],
    ...
    lm.utils.EventHub.prototype._propagateToParent = function(t) {
        ...
        document.createEvent ? (e = window.opener.document.createEvent("HTMLEvents"),
        e.initEvent(i, !0, !0)) : (e = window.opener.document.createEventObject(),
        e.eventType = i),
        e.eventName = i,
        e.__glArgs = t,
    ...
    lm.utils.copy(lm.utils.ReactComponentHandler.prototype, {
        ...
        _getReactClass: function() {
            ...
            if (t = this._container.layoutManager.getComponent(e),
            !t)
                throw new Error('React component "' + e + '" not found. Please register all components with GoldenLayout using `registerComponent(name, component)`');
            return t
        },
